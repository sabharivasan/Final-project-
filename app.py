...
model = joblib.load(r"D:\guvi\refer\Flight-Price-Prediction-main\flight_xgb.pkl")
    ...
    if request.method == 'POST':
        ...
        if Class_early == -1:
            return render_template('home.html', predictions='You will have to Pay approx Rs. {}'.format(output1),
                                   class1='Class Predicted : {}'.format(Class_pred))
        elif Stops_early == -1:
            return render_template('home.html', predictions='You will have to Pay approx Rs. {}'.format(output1),
                                   stops1='Number of Stops Predicted : {}'.format(Stops_pred.astype(int)))
        return render_template('home.html', predictions='You will have to Pay approx Rs. {}'.format(output1))
